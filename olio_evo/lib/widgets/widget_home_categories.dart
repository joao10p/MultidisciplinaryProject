...
class _WidgetCategoriesState extends State<WidgetCategories>{
        ...
        Row(
          ...
          children: [
            Padding(
              ...
              child: Text('Tutte le categorie', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold )
              ),
            ),
             Padding(
              padding: EdgeInsets.only(left:16, top: 10),
              child: Text('I tuoi preferiti', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold )
              ),
            ),
             Padding(
              padding: EdgeInsets.only(left:16, top: 10),
  ...
  Widget _categoriesList(){
       return  FutureBuilder<List<Category>>(
          future: apiSerivce.getCategories(),//getData(), // if you mean this method well return image url
